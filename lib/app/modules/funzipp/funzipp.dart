...
class funZipp extends StatelessWidget {
  final double diameter;

  const funZipp({super.key, this.diameter = 50});
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Container(
                              ...
                              width: SizeGet.getProportionWidth(375 / 5),
                    ...
                    children: [
                        ...
                        children: [
                          Column(
                            ...
                            children: const [
                              Padding(
                                ...
                                child: Text("Ticket Price (2)", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text("Convenience Fee", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text("Discount", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text("Delivery Charges", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text("Additional Charges", style: AppTextStyles.lineTextStyle),
                              ),
                            ],
                          ),
                          Column(
                            ...
                            children: const [
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text(":", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: EdgeInsets.only(bottom: 10.0),
                                child: Text(":", style: AppTextStyles.lineTextStyle),
                          ...
                          Column(
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsets.only(bottom: 10.0),
                                child: Text("\$ 319.00", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(bottom: 10.0),
                                child: Text("\$ 1.50", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(bottom: 10.0),
                                child: Text("\$ 0.00", style: AppTextStyles.lineTextStyle),
                              ),
                              Padding(
                                padding: const EdgeInsets.only(bottom: 10.0),
                                child: Text("\$ 0.00", style: AppTextStyles.lineTextStyle),
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text("Total Amount", style: AppTextStyles.lineText14BoldStyle,),
                            SizedBox(width: 1,),
                            Text(":", style: AppTextStyles.lineText14BoldStyle,),
                            Text("\$ 320.50", style: AppTextStyles.lineText14BoldStyle,),
                          ],
                        ),
                      ),
                    ],
            ...
            const Padding(
                padding: EdgeInsets.only(left: 20.0, top: 10.0, bottom: 10.0, right: 15.0),
              child: Text(
