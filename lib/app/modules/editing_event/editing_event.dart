...
class EditingEvent extends StatefulWidget {
  ...
  const EditingEvent({super.key, this.isSfald = false});
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        child: Text(
                          'Save Event',
                          style:
                              TextStyle(fontSize: 13, color: Color(0XFFC61236)),
                        ),
                      ),
                    ),
                    SizedBox(height: 18),
                    ...
                    Container(
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                            borderRadius:
                                BorderRadius.circular(8), // Border color
                          ),
                        ),
                        child: Text(
                          'Publish Event',
                      ...
                      child: TextButton(
                        ...
                        style: TextButton.styleFrom(
                          ...
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(8),
                            side: BorderSide(
                                color: Color(0XFFC9C6E1)), // Border color
                          ),
                        ),
                        child: Text(
                          'Cancel Event',
